...
function renderCommitInfo(data, commits) {
  ...
  dl.append('dd').text(d3.max(data, (d) => d.length) + ' chars');
...
const commitFilter = document.getElementById('commit-progress');
const commitTime = document.getElementById('commit-time');
commitTime.textContent = "any time";
...
commitFilter.addEventListener('input', onTimeSliderChange);
